...
echo "S3_ENDPOINT=$S3_ENDPOINT" >> /app/cron.env
echo "S3_BUCKET=$S3_BUCKET" >> /app/cron.env
echo "S3_ACCESS_KEY_ID=$S3_ACCESS_KEY_ID" >> /app/cron.env
echo "S3_SECRET_ACCESS_KEY=$S3_SECRET_ACCESS_KEY" >> /app/cron.env
echo "S3_REGION=$S3_REGION" >> /app/cron.env
echo "SMTP_SERVER=$SMTP_SERVER" >> /app/cron.env
echo "SMTP_PORT=$SMTP_PORT" >> /app/cron.env
echo "SMTP_USERNAME=$SMTP_USERNAME" >> /app/cron.env
echo "SMTP_PASSWORD=$SMTP_PASSWORD" >> /app/cron.env
echo "MAIL_FROM=$MAIL_FROM" >> /app/cron.env
echo "MAIL_TO=$MAIL_TO" >> /app/cron.env
